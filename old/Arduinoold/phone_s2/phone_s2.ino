...
timercheckStatus=t.setInterval(phnStatusInterval, sendSMS);
...
t.setTimeout(5000, deleteSMS);
	...
	else if(smsStatus==0||smsStatus==1) t.setTimeout(5000, readSMS);
