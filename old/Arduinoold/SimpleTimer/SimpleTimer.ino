...
void setup() {
  ...
  // timed actions setup
  /*Serial.print(timer.setInterval(15000, RepeatTask));
  Serial.print(timer.setTimeout(10000, OnceOnlyTask));
  Serial.print(timer.setInterval(1000, DigitalClockDisplay));
  Serial.println(timer.setTimer(1200, TenTimesTask, 10));*/
}
...
void loop() {
  ...
  delay(2000);
  Serial.println(timer.setTimeout(1000, OnceOnlyTask));
  Serial.println(timer.setTimeout(3000, OnceOnlyTask));
  Serial.println(timer.setTimeout(6000, OnceOnlyTask));
    Serial.println(timer.setTimeout(1000, OnceOnlyTask));
  Serial.println(timer.setTimeout(3000, OnceOnlyTask));
  Serial.println(timer.setTimeout(6000, OnceOnlyTask));
    Serial.println(timer.setTimeout(1000, OnceOnlyTask));
